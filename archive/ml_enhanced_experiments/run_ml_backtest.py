...
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), '../results/ml_backtest_results.csv')
OUTPUT_REPORT = os.path.join(os.path.dirname(__file__), '../results/ml_backtest_report.md')
